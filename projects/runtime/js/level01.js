var level01 = function (window) {
    ...
    window.opspark.runLevelInGame = function(game) {
        ...
        function createEnemy(x, y) {
            var enemy = game.createGameItem('enemy',25); // FIXME: This should be inside your createEnemy function! fixed
        ...
        function createReward(x, y) {
            var myReward = game.createGameItem('reward', 25); // FIXME: You should be using createGameItem, not createObstacle! fixed
            myReward.y = y;
            myReward.x = x;
